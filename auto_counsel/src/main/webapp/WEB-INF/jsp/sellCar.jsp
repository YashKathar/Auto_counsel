            ...
            <body>
                <%-- <%@ include file="common/navbar.jspf" %> --%>
                    <div class="container">
                        <div class="row">
                            <div
                                class="col-10 col-md-8 offset-1 offset-md-2 mt-5 rounded custom-form pb-5 pt-5 shadow-lg">

                                <h2 class="mb-4 text-center">Sell Your Car</h2>
                                <form action="/cars/sell" method="post" class="border border-light rounded p-4"
                                    enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <!-- <label for="carModel" class="form-label">Car Model</label> -->
                                        <input type="text" class="form-control custom-height" id="carModel"
                                            name="carModel" placeholder="Enter Car model" required>
                                    </div>

                                    <div class="mb-3">
                                        <!-- <label for="carName" class="form-label">Car Name</label> -->
                                        <input type="text" class="form-control custom-height" id="carName"
                                            name="carName" placeholder="Enter Car Name" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control custom-height" id="fuelType" name="fuelType"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        <!-- <label for="fuelType" class="form-label">Fuel Type</label> -->
                                        <select class="form-control custom-height" id="transmission" name="transmission"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="fs-6 form-control form-control-lg" id="carImage"
                                            name="carImage" accept="image/png, image/jpeg" required>
                                    </div>

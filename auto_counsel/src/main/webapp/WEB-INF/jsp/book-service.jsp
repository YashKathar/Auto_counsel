<%@ taglib prefix="c" uri="jakarta.tags.core" %>
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <head>
            ...
            <style>
                body {
                    background: linear-gradient(135deg, #2A2D3E, #1E1F2F);
                    ...
                    <div class="card-body">
                        <form id="carServiceForm" action="/carsService/book" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="garage" class="form-control" id="garage" required aria-label="garage">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="appointmentDate" class="form-control" id="appointmentDate"
                                    required aria-label="Appointment Date">
                            </div>
                        ...
                        <select name="status" class="form-control" id="status" required aria-label="Service Status">
                            ...
                            <!-- Submit Button -->
                            <button type="submit" class="btn submit-btn w-100">Book Service</button>
                        </form>
                    </div>
                </div>
            </div>

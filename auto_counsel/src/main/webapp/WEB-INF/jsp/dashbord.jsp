		...
		<body>
							...
							<div class="row no-gutters">
								<div class="language_signin">
									<ul class="nav justify-content-end">
										...
										<li class="nav-item"><a class="nav-link Sign_in" href="#"><i class="fa fa-user"
													aria-hidden="true"></i>Sign in/Sign up</a></li>
									</ul>
								</div>
							</div>
							<div class="row no-gutters">
								<nav class="navbar navbar-expand-md navbar-light  main_navbar">
									...
									<div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
										<ul class="navbar-nav justify-content-end">
											<li class="nav-item"><a class="nav-link" href="/cars/sellCar">Sell Car</a>
											</li>
											...
											<li class="nav-item dropdown">
												...
												<div class="dropdown-menu" aria-labelledby="servicesDropdown">
													<a class="dropdown-item" href="/carsService/book-service">Book
														Service</a>
													<a class="dropdown-item" href="/carsService/view">View Previous
														Servicing</a>
												</div>
											</li>
											...
											<li class="nav-item"><a class="nav-link" href="#automotive_marketplace">About</a>
											</li>
				...
				<div class="" style="width: 100%;">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100"
										src="${pageContext.request.contextPath}/images/slider_banner_4.png"
										alt="First slide">
								...
								<div class="carousel-item">
									<img class="d-block w-100"
										src="${pageContext.request.contextPath}/images/slider_banner_5.png"
										alt="Second slide">
									<div class="carousel-caption d-none d-md-block">
								...
								<div class="carousel-item">
									<img class="d-block w-100"
										src="${pageContext.request.contextPath}/images/slider_banner_1.png"
										alt="Third slide">
									<div class="carousel-caption d-none d-md-block">
								...
								<div class="carousel-item">
									<img class="d-block w-100"
										src="${pageContext.request.contextPath}/images/slider_banner_2.png"
										alt="fourth slide">
									<div class="carousel-caption d-none d-md-block">
										<h5>CHECK YOUR CAR VALUE</h5>
										<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
					...
					<div class="searchform">
						<div class="col mt-3">
							...
							<form action="/cars/buyCar" modelAttribute="searchCarDto" class="p-4 border rounded shadow">
								<div class=" ">
									<div class="mb-3">

										<!-- <label for="carName">Car Name</label> -->
										<input type="text" id="carName" name="carName" path="carName"
											class="form-control" placeholder="Enter car name">
									</div>

									<div class="mb-3">
										<!-- <label for="carModel" class="form-label">Car Model</label> -->
										<input type="text" id="carModel" name="carModel" path="carModel"
											class="form-control" placeholder="Enter car model">
									</div>

									<!-- <div class="mb-3">
										<label for="carBrand" class="form-label">Car Model</label>
										<input type="text" id="carBrand" name="carBrand" path="carBrand"
											class="form-control" placeholder="Enter car brand">
									</div> -->

									<div class="mb-3">
										<!-- <label for="fuelType" class="form-label">Fuel Type</label> -->
										<select id="fuelType" name="fuelType" path="fuelType" class="form-control form-select">
											<option value="">choose</option>
											<c:forEach var="item" items="${fuelType}">
												<option value="${item}"><span>${item}</span></option>
											</c:forEach>
										</select>
									</div>
							...
							<div class="row pt-3">
								...
								<div class="col-md-6">
									<div class="card mb-3">
										<div class="row no-gutters">
											<div class="col-md-5">
												<img src="${pageContext.request.contextPath}/images/automarket_2.png"
													alt="...">
											</div>
											<div class="col-md-7">
												<div class="card-body text-left">
			...
			<section id="buyers_sellers">
				<div class="container-fluid">
					...
					<div class="row no-gutters">
						<div class="col-3">
							<div class="nav flex-column nav-pills buyers_sellers_nav" id="v-pills-tab" role="tablist"
								aria-orientation="vertical">
								<a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
									role="tab" aria-controls="v-pills-home" aria-selected="true">MECHANIC</a> <a
									class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
									role="tab" aria-controls="v-pills-profile" aria-selected="false">CAR</a> <a
									class="nav-link" id="v-pills-messages-tab" data-toggle="pill"
									href="#v-pills-messages" role="tab" aria-controls="v-pills-messages"
									aria-selected="false">AUTO
									PARTS</a>
										...
										<div class="tab-pane fade show active  " id="home" role="tabpanel"
											...
											<div class="card-group ">
												...
												<div class="card">
													...
													<img src="${pageContext.request.contextPath}/images/money.png"
														class="card-img-top" alt="...">
												...
												<div class="card">
													...
													<img src="${pageContext.request.contextPath}/images/shiled.png"
														class="card-img-top" alt="...">
												...
												<div class="card">
													...
													<img src="${pageContext.request.contextPath}/images/account-benefit.png"
														class="card-img-top" alt="...">
									...
									<div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
										...
										<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
											...
											<li class="nav-item" role="presentation"><a class="nav-link"
													...
													aria-controls="profile" aria-selected="false">Sellers</a></li>
										</ul>
			...
			<section id="car_blog">
				<div class="container">
					...
					<div class="row">
						<div class="card-deck">
							<div class="card">
								<img src="${pageContext.request.contextPath}/images/ir_3.jpg" class="card-img-top"
									alt="...">
								<div class="card-body">
							...
							<div class="card">
								<img src="${pageContext.request.contextPath}/images/ir_4.jpg" class="card-img-top"
									alt="...">
								<div class="card-body">
							...
							<div class="card">
								<img src="${pageContext.request.contextPath}/images/iR-2.jpg" class="card-img-top"
									alt="...">
								<div class="card-body">
				...
				<div class="container">
					...
					<form>
						<div class="row no-gutters">
							...
							<div class="col form_text">
								<input type="text" class="form-control" placeholder="-- Select Store Type --">
							</div>
							<div class="col form_text">
								<input type="button" class="form-control search_btn" value="Search">
							</div>
						</div>
					</form>
			...
			<script src="<%= request.getContextPath() %>/JS/jquery-3.5.1.slim.min.js"></script>
